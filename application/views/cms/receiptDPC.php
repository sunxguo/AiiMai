...
<div class="" style="padding-left:30px;">
	<ul class="km-nav km-nav-tabs clearfix">
	  <li class="active"><a href="/cms/inventory">DPC Receipt</a></li>
	  <li><a href="/cms/subbranchStock">Q·cash Receipt</a></li>
	  <li><a href="/cms/multipleDelivery">Qxpress Receipt</a></li>
	</ul>
	<div class="km-panel km-panel-primary mt10" style="width: 98%;">
		<div class="km-panel-heading">Receipt Details</div>
