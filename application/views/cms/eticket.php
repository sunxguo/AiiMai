...
<div class="" style="padding-left:30px;">
	<ul class="km-nav km-nav-tabs clearfix">
	  <li class="active"><a href="/cms/inventory">Sales Summary</a></li>
	  <li><a href="/cms/subbranchStock">Use Confirmation</a></li>
	  <li><a href="/cms/multipleDelivery">Ticket Info.</a></li>
	  <li><a href="/cms/multipleDelivery">Reservation</a></li>
	</ul>
	<div class="km-panel km-panel-primary mt10" style="width: 98%;">
		<div class="km-panel-heading">Period</div>
	...
	<div class="km-panel km-panel-primary mt10" style="width: 98%;">
		<div class="km-panel-heading">Sales Summary</div>
		<div class="km-panel-body" style="padding:0px;">
			<table class="km-table">
				<tbody>
				  <tr>
