	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	  <ul class="nav navbar-nav">
		...
		<li>
			...
			<a href="/cms/login" class="km-btn km-btn-primary" style="display:inline-block;height:10px;line-height:10px;font-size:10px;color:white;margin-top:8px;">ASM Log In</a>
			<?php else:?>
