<div class="main-floor no-border" style="position:inherit;">
...
<!--					<input type="text" id="address2" placeholder="" class="inp-txt width400"><br>-->
			...
			<tr>
				...
				<td style="padding-right: 0px;">
					<img style="min-width: 300px;  min-height: 60px;max-height:100px;cursor:pointer;float: left;" id="businessLicenseImage" src="<?php echo $user->merchant_business_license;?>" onclick="setDivCenter('#showFullBusinessLicense',true);$('.km-modal-open').css('overflow','auto');">
			...
			<tr>
				...
				<td style="padding-right: 0px;">
					<img style="min-width: 300px;  min-height: 60px;max-height:100px;cursor:pointer;float: left;" id="bankAccountImage" src="<?php echo $user->merchant_bank_account;?>" onclick="setDivCenter('#showFullRecentBankStatement',true);$('.km-modal-open').css('overflow','auto');">
